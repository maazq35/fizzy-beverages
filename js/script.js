// ============================================
// FIZZY BEVERAGES - CUSTOM JAVASCRIPT
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animateElements = document.querySelectorAll('.feature-card, .product-card, .value-card, .mission-card, .benefit-item, .why-item');
    ...
    // Console message
    console.log('%c🍹 Fizzy Beverages Website', 'color: #00a859; font-size: 20px; font-weight: bold;');
    console.log('%cWebsite loaded successfully!', 'color: #666; font-size: 12px;');

});

// Add window load event for any final initializations
